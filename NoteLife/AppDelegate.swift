...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        window?.tintColor = #colorLiteral(red: 1, green: 0.5882352941, blue: 0, alpha: 1)
        UINavigationBar.appearance().barTintColor = #colorLiteral(red: 1, green: 0.5865499377, blue: 0, alpha: 1)
        UINavigationBar.appearance().tintColor = #colorLiteral(red: 1, green: 0.99997437, blue: 0.9999912977, alpha: 1)
        if let barFone = UIFont(name: "PingFang-TC-Medium", size: 24){
